...
export default {
    ...
    computed:{
        actionList() {
           ...
           return [
                ...
                {id:'action-do', visiable:!that.isRemoveWorking, color:"green", icon:"fa fa-eraser fa-lg fa-fw", size:"small", type:"secondary",  tooltip:"pages.remove.toolbar.fix"},
    ...
    methods:{
        ...
        startDo(outDir){
            ...
            Transfer.Tools.call('start.remove.exif', {
        ...
        stopDo(notice = true){
            ...
            if(_.keys(srcImagesMap).length > 0 && that.isRemoveWorking) {
                Transfer.Tools.call('stop.remove.exif', {
                    taskID: that.curFixTaskID,
                    data:{
                        src: srcImagesMap
                    }
