...
var CDataSectionNode = function (_TextNode_1$TextNode) {
    ...
    function CDataSectionNode() {
        ...
        return (0, _possibleConstructorReturn3.default)(this, (CDataSectionNode.__proto__ || (0, _getPrototypeOf2.default)(CDataSectionNode)).apply(this, arguments));
    }
    ...
    (0, _createClass3.default)(CDataSectionNode, [{
        ...
        value: function stringifyMultiLineContent(params, nodeIndentDepth) {
            if (/\n/.test(params.newlineChar)) {
                return '\n' + (0, _get3.default)(CDataSectionNode.prototype.__proto__ || (0, _getPrototypeOf2.default)(CDataSectionNode.prototype), 'stringifyMultiLineContent', this).call(this, params, nodeIndentDepth) + CDataSectionNode.generateIndentString(params.indentChar, nodeIndentDepth);
            } else {
                return (0, _get3.default)(CDataSectionNode.prototype.__proto__ || (0, _getPrototypeOf2.default)(CDataSectionNode.prototype), 'stringifyMultiLineContent', this).call(this, params, nodeIndentDepth);
            }
        }
        /**
         * @override
